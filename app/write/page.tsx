  ...
  return (
    <main className="min-h-screen bg-gray-50 px-5 py-8">
      <div className="mx-auto max-w-2xl">
        ...
        <form onSubmit={submitReview} className="mt-6 space-y-4 rounded-2xl bg-white p-5 shadow-sm">
          <div>
          ...
          <div>
            ...
            <select value={rating} onChange={(e) => setRating(e.target.value)} className="mt-2 w-full rounded-xl border px-4 py-3">
          ...
          <div>
            ...
            <select value={shiftType} onChange={(e) => setShiftType(e.target.value)} className="mt-2 w-full rounded-xl border px-4 py-3">
              <option>오픈</option>
              <option>미들</option>
              <option>마감</option>
              <option>야간</option>
          ...
          <div>
            ...
            <select value={workPeriod} onChange={(e) => setWorkPeriod(e.target.value)} className="mt-2 w-full rounded-xl border px-4 py-3">
          ...
          <div>
            ...
            <textarea value={pros} onChange={(e) => setPros(e.target.value)} className="mt-2 w-full rounded-xl border px-4 py-3" />
          </div>

          <div>
            <label className="font-semibold">단점</label>
            <textarea value={cons} onChange={(e) => setCons(e.target.value)} className="mt-2 w-full rounded-xl border px-4 py-3" />
          </div>
